...
namespace Console
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            repConstrutor.RegisterType(tipo).As<ICalculaPrecoMedio>();
            var container = repConstrutor.Build();

            var valores = new decimal[] { 54, 55, 51, 49, 63, 57, 54, 129 };
            var instancia = container.Resolve<ICalculaPrecoMedio>();
            var media = instancia.Calcula(valores);
